...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        char fitstcharV1 = FirstNonRepeatedCharacter.firstNonRepeatedCharV1(TEXT);

        displayExecutionTime(System.nanoTime() - startTimeV1);
        System.out.println("Found character:  " + fitstcharV1);

         System.out.println();
        System.out.println(" 256 ASCII codes solution:");
        long startTimeV2 = System.nanoTime();

        char firstcharV2 = FirstNonRepeatedCharacter.firstNonRepeatedCharV2(TEXT);
        ...
        char firstcharV3 = FirstNonRepeatedCharacter.firstNonRepeatedCharV3(TEXT);
        ...
        char firstcharV4 = FirstNonRepeatedCharacter.firstNonRepeatedCharV4(TEXT);
        ...
        String firstcharV5 = FirstNonRepeatedCharacter.firstNonRepeatedCharVCP4(TEXT_CP);
